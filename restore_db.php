...
if(file_exists(ROOT_DIR.'/database/status.ini')) //Restore in progress, don't do anything or break everything
{
...
if(isset($_GET['file']) && !empty($_GET['file'])) {
   ...
   $dbms_schema = ROOT_DIR.'/database/backup'.$_GET['file'].'.sql';

   $sql_query = @fread(@fopen($dbms_schema, 'r'), @filesize($dbms_schema)) or exit(json_encode(array('return'=>'nosql')));
   ...
   foreach($sql_query as $sql){
      ...
      $i++;
      $handle = fopen(ROOT_DIR.'/database/status.ini','w+');
